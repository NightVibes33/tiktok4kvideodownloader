#!/bin/bash
set -euo pipefail
base64 -D -i ios-build/app-icon-1024.b64 -o native-ios/app-icon-1024.png
ICON_SOURCE="native-ios/app-icon-1024.png"
ICON_SET="native-ios/TikTok4KNative/Assets.xcassets/AppIcon.appiconset"
mkdir -p "$ICON_SET"
